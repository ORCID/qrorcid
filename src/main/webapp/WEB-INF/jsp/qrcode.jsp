    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <p>
	                <spring:url var="zazzle_stickers_url" value="http://www.zazzle.com/api/create/at-238329472821236199?rf=238329472821236199&ax=Linkover&pd=217325965469569268&fwd=DesignTool&tc=&ic=&t_qrcode_iid=http%3A%2F%2F{base_url}qrcode/{base64ParamsJson}/generate.png&t_orcid_txt=%20{website}">
	                    <spring:param name="base_url">
